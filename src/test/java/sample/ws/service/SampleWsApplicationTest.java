...
public class SampleWsApplicationTest {
    ...
    public void testHelloRequest() {
        ...
        String request = "<q0:sayHello xmlns:q0=\"http://localhost:8080/\"><myname>Kasia</myname></q0:sayHello>";
        ...
        assertThat(this.output.toString(),
                   containsString("<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                                  + "<ns2:sayHelloResponse xmlns:ns2=\"http://localhost:8080/\">"
                                  + "<return>Hello, Welcome to CXF Spring boot Kasia!!!</return>"
